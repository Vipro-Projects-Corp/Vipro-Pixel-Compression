...
Public Class conv
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        openFileDialog.Filter = "Pixel Compressed Folder (*.pix, *.pi)|*.pix, *.pi|All Types (*.*)|*.*"
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Dim targetPath As String = filesave & ".zip"
    ...
    Private Sub zpi_Load(sender As Object, e As EventArgs) Handles MyBase.Load
